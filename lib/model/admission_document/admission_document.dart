class AdmissionDocument {
  ...
  factory AdmissionDocument.fromJson(Map<String, dynamic> json) {
    return AdmissionDocument(
      id: setId(json),
      admissionDocument: setAdmissionDocument(json),
  ...
  AdmissionDocument copyWith({
    ...
    id: id ?? this.id,
    admissionDocument: admissionDocument ?? this.admissionDocument,
  ...
  static AdmissionDocument defaultValues() => AdmissionDocument(
    id: '',
    admissionDocument: '',
    createdBy: '',
    updatedBy: '',
  ...
  Map<String, dynamic> toJson() => {'admission_document': admissionDocument};
  ...
  static String setAdmissionDocument(Map<String, dynamic> json) {
    if (json.containsKey('admission_document')) {
      if (json['admission_document'] != null &&
          json['admission_document'] is String &&
          json['admission_document'].toString().isNotEmpty) {
        return json['admission_document'];
      }
    }
