class EducationBoard {
  ...
  EducationBoard copyWith({String? id, String? educationBoard, String? createdBy, String? updatedBy, DateTime? createdAt, DateTime? updatedAt}) =>
      EducationBoard(
        id: id ?? this.id,
  ...
  static EducationBoard defaultValues() =>
      EducationBoard(id: '', educationBoard: '', createdBy: '', updatedBy: '', createdAt: DateTime(1500, 01, 01), updatedAt: DateTime(1500, 01, 01));
  ...
  static String setEducationBoard(Map<String, dynamic> json) {
    if (json.containsKey('education_board')) {
      if (json['education_board'] != null && json['education_board'] is String && json['education_board'].toString().isNotEmpty) {
