  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      routes: {
        ...
        RoutePaths.activeSchools: (context) => const ActiveSchoolScreen(),
        RoutePaths.inactiveSchools: (context) => const DashboardScreen(),
        ...
        RoutePaths.facilities: (context) => const FacilityScreen(),
        ...
        RoutePaths.academicClassForm: (context) => const AcademicClassFormScreen(),
        RoutePaths.academicClasses: (context) => const AcademicClassScreen(),
