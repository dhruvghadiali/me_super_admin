...
class DistrictListViewWidget extends StatelessWidget {
  const DistrictListViewWidget({super.key, required this.onRefresh, required this.districts});

  final Function onRefresh;
  final List<District> districts;

  Future<void> deleteDistrict({required BuildContext context, required District district}) async {
  ...
  Future<void> editDistrict({required BuildContext context, required District district}) async {
    final DistrictController districtController = Get.put(DistrictController());
    districtController.setDistrictForm(district);
  }

  void onAddDistrictClicked(BuildContext context) {
    final DistrictController districtController = Get.put(DistrictController());
    districtController.resetDistrictForm();
    Navigator.pushNamed(context, RoutePaths.districtForm);
  }
          ...
          children: [
            ...
            Positioned(
              ...
              child: FloatingActionButton(
                onPressed: () => onAddDistrictClicked(context),
