...
class _SchoolWidgetState extends State<SchoolWidget> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return TabContainer(
      ...
      tabs: [
        Text(
          ...
          style: Theme.of(context).textTheme.titleMedium?.copyWith(
            color: _currentIndex == 0 ? themeData.offWhite : themeData.eerieBlack,
        ...
        Text(
          'Inactive Schools',
          style: Theme.of(context).textTheme.titleMedium?.copyWith(
            color: _currentIndex == 1 ? themeData.offWhite : themeData.eerieBlack,
        ...
        Text(
          'Add New Schools',
          style: Theme.of(context).textTheme.titleMedium?.copyWith(
            color: _currentIndex == 2 ? themeData.offWhite : themeData.eerieBlack,
      ...
      children: [
        ...
        TabContainerWidget(child: Container()),
      ],
    );
  }
}
