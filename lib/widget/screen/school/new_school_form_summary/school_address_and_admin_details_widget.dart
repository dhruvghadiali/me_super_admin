                  ...
                  return MapEntry(
                    ...
                    Column(
                      ...
                      children: [
                        Divider(color: themeData.offWhite, thickness: 1),
                        SizedBox(height: 20),
                        NewSchoolFormSummaryTabCardTitleWidget(title: "${appLocalizations.newSchoolSummarySchoolAddressTitle.toUpperCase()} ${index + 1}"),
                        NewSchoolFormSummaryTabCardTextWidget(
                          title: appLocalizations.newSchoolSummarySchoolAddressLabelText.toUpperCase(),
                          value: address.address.isNotEmpty ? address.address : appLocalizations.newSchoolSummarySchoolAddressEmptyValue,
                        ),
                        NewSchoolFormSummaryTabCardTextWidget(
                          title: appLocalizations.newSchoolSummarySchoolStateLabelText.toUpperCase(),
                          value: address.state.name.isNotEmpty ? address.state.name : appLocalizations.newSchoolSummarySchoolAddressEmptyValue,
                        ),
                        NewSchoolFormSummaryTabCardTextWidget(
                          title: appLocalizations.newSchoolSummarySchoolDistrictLabelText.toUpperCase(),
                          value: address.district.name.isNotEmpty ? address.district.name : appLocalizations.newSchoolSummarySchoolAddressEmptyValue,
                        ),
                        NewSchoolFormSummaryTabCardTextWidget(
                          title: appLocalizations.newSchoolSummarySchoolCityLabelText.toUpperCase(),
                          value: address.city.name.isNotEmpty ? address.city.name : appLocalizations.newSchoolSummarySchoolAddressEmptyValue,
                        ),
                        NewSchoolFormSummaryTabCardTextWidget(
                          title: appLocalizations.newSchoolSummarySchoolAreaNameLabelText.toUpperCase(),
                          value: address.areaName.name.isNotEmpty ? address.areaName.name : appLocalizations.newSchoolSummarySchoolAddressEmptyValue,
                        ),
                        NewSchoolFormSummaryTabCardTextWidget(
                          title: appLocalizations.newSchoolSummarySchoolZipcodeLabelText.toUpperCase(),
                          value: address.zipcode.zipcode.isNotEmpty ? address.zipcode.zipcode : appLocalizations.newSchoolSummarySchoolAddressEmptyValue,
                        ),
                        NewSchoolFormSummaryTabCardTitleWidget(title: "${appLocalizations.newSchoolSummarySchoolAdminTitle.toUpperCase()} ${index + 1}"),
                        NewSchoolFormSummaryTabCardTextWidget(
                          title: appLocalizations.newSchoolSummarySchoolAdminFirstNameLabelText.toUpperCase(),
                          value:
                              schoolAdmins[index].firstName.isNotEmpty ? schoolAdmins[index].firstName : appLocalizations.newSchoolSummarySchoolAdminEmptyValue,
                        ),
                        NewSchoolFormSummaryTabCardTextWidget(
                          title: appLocalizations.newSchoolSummarySchoolAdminLastNameLabelText.toUpperCase(),
                          value:
                              schoolAdmins[index].lastName.isNotEmpty ? schoolAdmins[index].lastName : appLocalizations.newSchoolSummarySchoolAdminEmptyValue,
                        ),
                        NewSchoolFormSummaryTabCardTextWidget(
                          title: appLocalizations.newSchoolSummarySchoolAdminEmailLabelText.toUpperCase(),
                          value: schoolAdmins[index].email.isNotEmpty ? schoolAdmins[index].email : appLocalizations.newSchoolSummarySchoolAdminEmptyValue,
                        ),
                        NewSchoolFormSummaryTabCardTextWidget(
                          title: appLocalizations.newSchoolSummarySchoolAdminPhoneNumberLabelText.toUpperCase(),
                          value:
