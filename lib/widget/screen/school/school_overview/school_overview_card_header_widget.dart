...
class SchoolOverviewCardHeaderWidget extends StatelessWidget {
  const SchoolOverviewCardHeaderWidget({super.key, required this.isNewRecord});
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        Expanded(
          child: Text(
            "School Information".toUpperCase(),
            maxLines: 2,
