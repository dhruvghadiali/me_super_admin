...
class FacilityTypeCardWidget extends StatelessWidget {
  const FacilityTypeCardWidget({super.key, required this.facilityType});
          ...
          child: Column(
            ...
            children: [
              ...
              AuditTrailWidget(
                ...
                audioUserInfo: facilityType.createdBy,
                auditDateTimeInfo: DateFormat('dd MMM yyyy hh:mm a').format(facilityType.createdAt),
              ),
              AuditTrailWidget(
                audioDateTimeInfoLabel: 'Updated At:',
                audioInfoLabel: 'Updated By:',
                audioUserInfo: facilityType.updatedBy,
                auditDateTimeInfo: DateFormat('dd MMM yyyy hh:mm a').format(facilityType.updatedAt),
              ),
            ],
          ),
        ),
